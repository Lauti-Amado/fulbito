...
| Etapa | Descripción |
|-------|-------------|
| `01-vision.md` | Define la visión del producto, el problema que busca resolver, el público objetivo y la propuesta de valor de Fulbito. |
...
| `09-roadmap/` | Evolución del producto, funcionalidades futuras y planificación de versiones. |

---

# Objetivos de la documentación

- Mantener un registro de las decisiones tomadas durante el proyecto.
- Facilitar la incorporación de nuevos colaboradores.
- Servir como guía durante el desarrollo.
- Evitar la pérdida de conocimiento a medida que el proyecto evoluciona.
- Garantizar la trazabilidad entre la idea inicial y la implementación final.

---

# Convenciones

- Cada etapa posee su propia carpeta o documento principal.
- Todos los documentos están escritos en formato Markdown (`.md`).
- Las decisiones importantes deberán documentarse antes de su implementación.
- La documentación deberá mantenerse actualizada a medida que evolucione el proyecto.

---

> **Un buen software no solo se construye con código. También se construye con decisiones bien documentadas.**

---

## Navegación

➡ **Siguiente:** `01-vision.md`